      ...
      <div class="right-register">
        <transition-group name="slide-fade" tag="div">
          ...
          <div key="email" class="input-group">
            <input v-model="email" class="register-input" placeholder="邮箱地址" @focus="animateInput('email')"
          ...
          <div key="phone" class="input-group">
            <input v-model="phone" class="register-input" placeholder="手机号码" @focus="animateInput('phone')"
...
export default {
  ...
  methods: {
    ...
    async registerFunc() {
      if (!this.account || !this.password || !this.againPassword || !this.username || !this.email || !this.phone) {
      ...
      const userRegisterDto = {
        ...
        email: this.email, // 包含邮箱
        phone: this.phone  // 包含手机号
      }
