    ...
    <div class="app-container">
        ...
        <header class="app-header">
            <div class="header-content">
                <div class="main-nav">
                    <Logo class="logo" :logoSize="20" :fontSize="18" textColor="rgb(51,51,51)" sysName="宠物领养系统" />
                </div>
                    ...
                    <div>
                        <div class="user-avatar-container">
                            ...
                            <el-upload style="margin-left: 20px;" class="avatar-uploader"
                                action="/api/v1.0/pet-adopt-api/admin/common/upload" :show-file-list="false"
...
export default {
    ...
    data() {
        return {
            ...
            navItems: [
                { path: '/pet-list', icon: 'el-icon-help', title: '宠物大厅' },
                { path: '/pet-post', icon: 'el-icon-info', title: '经验贴子' },
                { path: '/pet-report', icon: 'el-icon-menu', title: '总体概况' },
