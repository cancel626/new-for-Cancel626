      ...
      <div class="right-login">
        <transition-group name="slide-fade" tag="div">
          ...
          <div key="footer" class="login-footer">
            <p>其他方式: <span class="register-link" @click="toLoginByEmail">点击邮箱登录</span></p>
...
export default {
  ...
  methods: {
    //跳转到邮箱登录页面
    toLoginByEmail() {
      this.$router.push('/login-by-email');
    },
    ...
    async login() {
      ...
      // 构建登录入参 UserLoginDto
      const userLoginDto = { account: this.account, password: bcryptPassword, captchaCode: this.captchaCode };
      try {
