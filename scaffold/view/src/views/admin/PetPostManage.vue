    ...
    <div class="container">
        ...
        <div>
            <el-table :data="apiResult.data">
                ...
                <el-table-column prop="isDelete" width="110" label="删除状态">
                    <template #default="scope">
                        <el-tag size="mini">{{ scope.row.isDelete ? '已删除' : '未删除' }}</el-tag>
        ...
        <el-drawer size="45%" title="帖子信息详情" :visible.sync="drawer" :direction="direction">
            ...
            <div class="post-detail-container">
                ...
                <div class="post-cover" v-if="petPost.cover">
                    <el-image :src="petPost.cover" fit="cover"
    ...
    methods: {
        ...
        handleChange(obj) {
            ...
            switch (Number(obj.value)) {
                case 0: // 未审核
                    this.petPostQueryDto.isAudit = 0;
                    delete this.petPostQueryDto.isDelete;
                    break;
                case 1: // 已审核
                    this.petPostQueryDto.isAudit = 1;
                    delete this.petPostQueryDto.isDelete;
                    break;
                case 2: // 未删除
                    this.petPostQueryDto.isDelete = 0;
                    delete this.petPostQueryDto.isAudit;
                    break;
                case 3: // 已删除
                    this.petPostQueryDto.isDelete = 1;
                    delete this.petPostQueryDto.isAudit;
                    break;
                default: // 全部
                    delete this.petPostQueryDto.isAudit;
