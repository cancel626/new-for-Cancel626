        ...
        <el-tab-pane label="核心信息" name="first">
          <div>
            <div class="user-avatar">
              ...
              <el-upload class="avatar-uploader" action="/api/v1.0/pet-adopt-api/admin/common/upload" :show-file-list="false"
...
export default {
  ...
  methods: {
    ...
    handleImageSuccess(res, file) {
      ...
      if (res.code === 200) {
        this.avatar = res.message; // 响应里面的data，即后端返回的上传后的图片链接
      }
    },
    // 用户角色状态选中事件
    handleChange(obj) {
